...
# 🏥 AI-Powered Health Monitoring System - Streamlit Version
...
def create_metrics_summary(current_data):
    ...
    with col1:
        ...
        <div class="metric-card">
            <h3 style="color: #667eea; margin: 0;">❤️ Heart Rate</h3>
    ...
    with col2:
        st.markdown("""
        <div class="metric-card">
            <h3 style="color: #667eea; margin: 0;">🫁 Blood Oxygen</h3>
    ...
    with col3:
        st.markdown("""
        <div class="metric-card">
            <h3 style="color: #667eea; margin: 0;">🚶 Daily Steps</h3>
            <h2 style="margin: 0;">{}</h2>
    ...
    with col4:
        st.markdown("""
        <div class="metric-card">
            <h3 style="color: #667eea; margin: 0;">📊 Health Score</h3>
...
def main():
    ...
    <div class="main-header">
        <h1>🏥 AI-Powered Health Monitoring System</h1>
    ...
    page = st.sidebar.selectbox(
        "Choose a page",
        ["📊 Real-time Dashboard", "🔍 Data Analysis", "🤖 AI Predictions", "📈 System Statistics"]
    )

    # Initialize session state for data persistence
    if 'health_data' not in st.session_state:
        with st.spinner("🔄 Initializing health monitoring system..."):
...
def show_dashboard():
    ...
    st.subheader("📝 Submit New Health Data")
    ...
    with st.form("health_data_form"):
        ...
        submitted = st.form_submit_button("🔍 Analyze Health Data", use_container_width=True)
...
def analyze_health_data(user_id, heart_rate, spo2, steps, age, fitness_level):
    ...
    try:
        ...
        if spo2 < 95:
            recommendations.append("🫁 Monitor oxygen levels closely and consult a doctor")
        if steps < 5000:
...
def show_data_analysis():
    ...
    st.header("🔍 Health Data Analysis & Exploration")
    ...
    tab1, tab2, tab3, tab4 = st.tabs(["❤️ Heart Rate", "🫁 SpO2", "🚶 Steps", "👥 Demographics"])
...
def show_ai_predictions():
    ...
    st.header("🤖 AI-Powered Health Predictions")
    ...
    with col1:
        st.markdown("""
        <div class="metric-card">
            <h3 style="color: #667eea; margin: 0;">🔍 Anomaly Detection</h3>
    ...
    with col2:
        st.markdown("""
        <div class="metric-card">
            <h3 style="color: #667eea; margin: 0;">⚡ Risk Classification</h3>
    ...
    with col3:
        st.markdown("""
        <div class="metric-card">
            <h3 style="color: #667eea; margin: 0;">📈 Predictions Made</h3>
    ...
    st.subheader("🔮 Real-time Health Prediction")

    with st.expander("📝 Input Health Parameters", expanded=True):
        col1, col2, col3, col4 = st.columns(4)
...
def run_ai_prediction(hr, spo2, steps, age, fitness, condition, hour, weekend):
    ...
    try:
        ...
        with col1:
            ...
            anomaly_status = "🚨 ANOMALY DETECTED" if is_anomaly else "✅ NORMAL PATTERN"
        ...
        # Heart rate analysis
        if hr > 100:
            analysis_points.append("❤️ **Elevated Heart Rate**: Consider stress management and relaxation techniques")
        elif hr < 50:
            analysis_points.append("❤️ **Low Heart Rate**: May indicate excellent fitness or require medical evaluation")
        else:
            analysis_points.append("❤️ **Normal Heart Rate**: Within healthy range")

        # SpO2 analysis
        if spo2 < 95:
            analysis_points.append("🫁 **Low Oxygen Saturation**: Immediate medical attention recommended")
        elif spo2 < 98:
            analysis_points.append("🫁 **Borderline SpO2**: Monitor closely and consider consultation")
        else:
            analysis_points.append("🫁 **Excellent Oxygen Levels**: Optimal respiratory function")

        # Activity analysis
        if steps < 100:
            analysis_points.append("🚶 **Very Low Activity**: Increase movement to improve health")
        elif steps < 300:
            analysis_points.append("🚶 **Moderate Activity**: Good baseline activity level")
        else:
            analysis_points.append("🚶 **High Activity**: Excellent activity level for this hour")

        # Age-related insights
        if age > 65:
            analysis_points.append("👥 **Senior Health**: Regular monitoring recommended for age group")
        elif age < 30:
            analysis_points.append("👥 **Young Adult**: Focus on establishing healthy habits")
        else:
            analysis_points.append("👥 **Adult Health**: Maintain current health monitoring routine")

        for point in analysis_points:
            st.info(point)

        # Risk factors summary
        st.markdown("### ⚠️ Risk Factors Summary")
        ...
        with col2:
            ...
            if protective_factors:
                ...
                st.markdown("• Focus on building protective health factors")
...
def show_system_stats():
    ...
    try:
        ...
        performance_df = pd.DataFrame({
            ...
            'Accuracy': ['94.2%', '91.8%', '87.5%'],
            'Status': ['✅ Active', '✅ Active', '⚠️ Training'],
